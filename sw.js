...
var ARCHIVOS = [
  ...
  './tools/damas/index.html',
  './tools/damas/app.js',
  './tools/damas/data.js',
  './tools/damas/strings.js',
  './tools/damas/styles.css',
  './tools/ajedrez/index.html',
  './tools/ajedrez/app.js',
  './tools/ajedrez/data.js',
  './tools/ajedrez/strings.js',
  './tools/ajedrez/styles.css',
  './tools/cuatro-en-raya/index.html',
  './tools/cuatro-en-raya/app.js',
  './tools/cuatro-en-raya/data.js',
  './tools/cuatro-en-raya/strings.js',
  './tools/cuatro-en-raya/styles.css',
  ...
  './tools/la-tienda/index.html',
  './tools/la-tienda/app.js',
  './tools/la-tienda/data.js',
  './tools/la-tienda/strings.js',
  './tools/la-tienda/styles.css',
