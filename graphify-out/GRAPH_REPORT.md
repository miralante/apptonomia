...
## Corpus Check
- 395 files · ~303,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1753 nodes · 3281 edges · 312 communities (253 shown, 59 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 95 edges (avg confidence: 0.71)
- Token cost: 620,910 input · 0 output
...
7. `Guía para profesionales y familias (ES)` - 17 edges
8. `Información técnica (ES)` - 16 edges
9. `Hidden route /equipo/ — Guía para el equipo de apoyo` - 16 edges
...
- **Three-role project model (end user, support, construction) restated across roles and contributing docs** — doc_en_roles_roles, contributing_contributing, contributing_es_contributinges [EXTRACTED 1.00]
...
## Communities (312 total, 59 thin omitted)
...
### Community 1 - "Es Docs"
Cohesion: 0.14
Nodes (44): Team Guide (EN) — Guide for professionals and families, Technical Documentation (EN), Catálogo de actividades (ES), Guía para profesionales y familias (ES), Therapeutic objective coverage taxonomy, Guía rápida de uso (ES), I18N.md — Arquitectura multiidioma de Apptonomia, Multi-file per-locale i18n system (strings.<locale>.js) (+36 more)

### Community 2 - "En Docs"
Cohesion: 0.08
Nodes (39): agent.md (compatibility pointer), AGENTS.md (compatibility pointer), Ajustes (Settings) hidden-route page, CLAUDE.md — AI Agent Workflow, graphify usage rules, tools/dictionary activity (as consumer of word bank), Dictionary Word Bank (content/dictionary), Los tres roles del proyecto (ES) (+31 more)
...
### Community 9 - "Package"
Cohesion: 0.07
Nodes (26): firebase-tools, author, description, devDependencies, firebase-tools, playwright, keywords, license (+18 more)
...
## Knowledge Gaps
- **167 isolated node(s):** `name`, `short_name`, `description`, `lang`, `start_url` (+162 more)
...
- **Should `Es Docs` be split into smaller, more focused modules?**
