/* ==========================================================================
   ...
   - DATA.numberRow / DATA.rows: teclas del teclado español (estructura física,
     ...
     'lt'/'rt' = pulgar izquierdo/derecho (solo en DATA.layouts.movil).
   ...
   - DATA.layouts: los teclados visuales que se pueden elegir
     (simplificado / normal / extendido / movil). "extendido" añade el
     teclado numérico aparte (ver DATA.numpad); eso se dibuja en app.js.
     "movil" es el único tocable de verdad (ver app.js, clase 'tocable'):
     los demás son decorativos y requieren un teclado físico externo.
...
DATA.layouts = {
  ...
  movil: [
    [
      ...
      { ch: 'r', finger: 'lt' }, { ch: 't', finger: 'lt' },
      { ch: 'y', finger: 'rt' }, { ch: 'u', finger: 'rt' }, { ch: 'i', finger: 'rt' },
      { ch: 'o', finger: 'rt' }, { ch: 'p', finger: 'rt' }
    ],
    [
      { ch: 'a', finger: 'lt' }, { ch: 's', finger: 'lt' }, { ch: 'd', finger: 'lt' },
      { ch: 'f', finger: 'lt' }, { ch: 'g', finger: 'lt' },
      { ch: 'h', finger: 'rt' }, { ch: 'j', finger: 'rt' }, { ch: 'k', finger: 'rt' },
      { ch: 'l', finger: 'rt' }, { ch: 'ñ', finger: 'rt' }
    ],
    [
      { ch: 'z', finger: 'lt' }, { ch: 'x', finger: 'lt' }, { ch: 'c', finger: 'lt' },
      { ch: 'v', finger: 'lt' }, { ch: 'b', finger: 'lt' },
      { ch: 'n', finger: 'rt' }, { ch: 'm', finger: 'rt' }, { ch: ',', finger: 'rt' },
      { ch: '.', finger: 'rt' }, { ch: '-', finger: 'rt' }
    ],
    [
      { ch: ' ', finger: 'th', wide: true, label: 'espacio' }
    ]
