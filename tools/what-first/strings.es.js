/* ============================================================
   Apptonomia — Textos de que-primero (ES)
...
(function () {
  ...
  "transferencia": "Esto te servirá para decidir qué hacer primero cuando hay varias cosas a la vez: en casa, en el cole o cuando llega la hora de salir.",
  }, 'es');
})();
