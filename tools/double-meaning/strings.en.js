/* ============================================================
   Apptonomia — Double Meaning strings (EN)
...
(function () {
  ...
  App.i18n.register({
    ...
    "instruction": "Some words can mean two different things. Listen to the phrase and decide if it has one meaning or two.",
    "chooseLevel": "Choose a group of phrases",
    "itemsCount": "8 phrases",
    "done": "✔ Done",
    "chooseAnotherLevel": "Choose another group",
    "question": "Does this phrase have a double meaning?",
    "optionYes": "Yes, it can mean two things",
    "optionNo": "No, it only means one thing",
