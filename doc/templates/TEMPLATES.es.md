...
├── SECURITY.es.md
├── CLOUDFLARE.md
├── LICENSE                       ← MIT, línea de copyright dice "Miralante {{DISPLAY_ES}} contributors" (forma inglesa {{DISPLAY_EN}})
├── THIRD_PARTY_LICENSES.md       ← (solo si el hermano publica activos de terceros bajo una licencia distinta de MIT)
