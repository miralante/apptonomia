...
Esta guía explica paso a paso cómo usar Apptonomia.
...
- Abre el navegador y visita [apptonomia.web.app](https://apptonomia.web.app)

**Opción B: Desde tu ordenador**
- Abre una terminal en la carpeta del proyecto
- Ejecuta: `python -m http.server 8080`
- Abre: [http://localhost:8080/site/index.html](http://localhost:8080/site/index.html)
...
En cada pantalla verás un botón **🔊** junto a los textos importantes.

**Para escuchar:**
1. Toca el botón 🔊
2. Escucha la voz que lee el texto
...
> **Nota**: El botón de ajustes está oculto. Para encontrarlo, escribe `/ajustes` al final de la dirección web.
