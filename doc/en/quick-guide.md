...
This guide explains step by step how to use Apptonomia.
...
**Option A: From the internet**
- Open your browser and visit [apptonomia.web.app](https://apptonomia.web.app)

**Option B: From your computer**
- Open a terminal in the project folder
- Run: `python -m http.server 8080`
- Open: [http://localhost:8080/site/index.html](http://localhost:8080/site/index.html)
...
On each screen you'll see a **🔊** button next to important texts.

**To listen:**
1. Tap the 🔊 button
2. Listen to the voice reading the text
...
> **Note**: The settings button is hidden. To find it, type `/ajustes` at the end of the web address.
...
- [Activity catalog](activities.md) — Complete list of 57 activities
