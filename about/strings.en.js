...
(function () {
  ...
  App.i18n.register({
    ...
    "areasIntro2": ', each with its own color. An activity can work on more than one area (Keyboard, for example, trains coordination as well as writing), but it always appears once in the menu, under its main module.',
    ...
    "areaReasoningTitle": '🔢 Thinking and counting',
    "areaReasoningText": 'Reasoning, logic, numbers, money, telling time and rule-based games.',
    "areaReasoningCount": '17 activities',
